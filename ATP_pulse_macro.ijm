								...
								if (choice=="analyze"){
									...
									for(i=0;i<list.length;i++){
												...
												if (endsWith(image, ".tif")) {
													...
													selectWindow(name);
														run("Duplicate...", "title=first_pulse duplicate range=55-134");
														first_pulse=getTitle();
															...
															run("Clear Results");
														selectWindow(name);
														run("Duplicate...", "title=second_pulse duplicate range=145-224");
														second_pulse=getTitle();
															...
															run("Clear Results");
														selectWindow(name);
														run("Duplicate...", "title=third_pulse duplicate range=235-314");
